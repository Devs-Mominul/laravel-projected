        ...
        <div class="container container-fluid-sm">
            <div class="hero-slider">
                <div class="hero-slider-item">
                    <div class="slider-bg">
                        <img src="frontend/assets/images/slider/slide-1.jpg" alt="">
                    </div>
                ...
                <div class="hero-slider-item">
                    <div class="slider-bg">
                        <img src="frontend/assets/images/slider/slide-2.jpg" alt="">
                    </div>
                    <div class="slider-content">
                        <div class="slide-title">
                            <h2>Trendy & Unique
                ...
                <div class="hero-slider-item">
                    <div class="slider-bg">
                        <img src="frontend/assets/images/slider/slide-3.jpg" alt="">
                    </div>
                    <div class="slider-content">
                        <div class="slide-title">
                            <h2>Trendy & Unique
        ...
        <div class="container">
            ...
            <div class="featured-categorie-slider owl-carousel">
                <div class="featured-item">
                    <div class="images">
                        <img src="frontend/assets/images/featured-categorie/1.png" alt="">
                    </div>
                    <div class="text">
                ...
                <div class="featured-item">
                    <div class="images">
                        <img src="frontend/assets/images/featured-categorie/2.png" alt="">
                    </div>
                    <div class="text">
                ...
                <div class="featured-item">
                    <div class="images">
                        <img src="frontend/assets/images/featured-categorie/3.png" alt="">
                    </div>
                    <div class="text">
                ...
                <div class="featured-item">
                    <div class="images">
                        <img src="frontend/assets/images/featured-categorie/4.png" alt="">
                    </div>
                    <div class="text">
                ...
                <div class="featured-item">
                    <div class="images">
                        <img src="frontend/assets/images/featured-categorie/5.png" alt="">
                    </div>
                    <div class="text">
                ...
                <div class="featured-item">
                    <div class="images">
                        <img src="frontend/assets/images/featured-categorie/6.png" alt="">
                    </div>
                    <div class="text">
                ...
                <div class="featured-item">
                    <div class="images">
                        <img src="frontend/assets/images/featured-categorie/7.png" alt="">
                    </div>
                    <div class="text">
                ...
                <div class="featured-item">
                    <div class="images">
                        <img src="frontend/assets/images/featured-categorie/8.png" alt="">
                    </div>
                    <div class="text">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            <div class="image">
                                <img src="frontend/assets/images/interest-product/1.png" alt="">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            <div class="image">
                                <img src="frontend/assets/images/interest-product/2.png" alt="">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            <div class="image">
                                <img src="frontend/assets/images/interest-product/3.png" alt="">
                                <div class="tag new">New</div>
                            </div>
                            <div class="text">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            <div class="image">
                                <img src="frontend/assets/images/interest-product/4.png" alt="">
                                <div class="tag sale">Sale</div>
                            </div>
                            <div class="text">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            <div class="image">
                                <img src="frontend/assets/images/interest-product/5.png" alt="">
                                <div class="tag new">New</div>
                            </div>
                            <div class="text">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            <div class="image">
                                <img src="frontend/assets/images/interest-product/6.png" alt="">
                                <div class="tag sale">Sale</div>
                            </div>
                            <div class="text">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            <div class="image">
                                <img src="frontend/assets/images/interest-product/7.png" alt="">
                                <div class="tag new">New</div>
                            </div>
                            <div class="text">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-item">
                            <div class="image">
                                <img src="frontend/assets/images/interest-product/8.png" alt="">
                                <div class="tag sale">Sale</div>
                            </div>
                            <div class="text">
        ...
        <div class="container">
            <div class="upcoming-offer">
                ...
                <div class="left-image">
                    <img src="frontend/assets/images/upcomming-left.png" alt="">
                </div>
                ...
                <div class="right-image">
                    <img src="frontend/assets/images/upcomming-right.png" alt="">
                </div>
                ...
                <div class="col-lg-6 col-12">
                    <ul class="special-product">
                        <li>
                            <div class="product-item">
                                <div class="image">
                                    <img src="frontend/assets/images/special-product-1.jpg" alt="">
                                </div>
                                <div class="text">
                ...
                <div class="col-lg-6 col-12">
                    <ul class="special-product">
                        <li>
                            <div class="product-item">
                                <div class="image">
                                    <img src="frontend/assets/images/special-product-2.jpg" alt="">
                                </div>
                                <div class="text">
    ...
    <section class="themart-trendingproduct-section section-padding">
        <div class="container">
            ...
            <div class="trendin-slider owl-carousel">
                <div class="product-item">
                    <div class="image">
                        <img src="frontend/assets/images/trending-product/1.png" alt="">
                        <div class="tag new">New</div>
                    </div>
                    <div class="text">
                ...
                <div class="product-item">
                    <div class="image">
                        <img src="frontend/assets/images/trending-product/2.png" alt="">
                        <div class="tag sale">Sale</div>
                    </div>
                    <div class="text">
                ...
                <div class="product-item">
                    <div class="image">
                        <img src="frontend/assets/images/trending-product/3.png" alt="">
                        <div class="tag new">New</div>
                    </div>
                    <div class="text">
                ...
                <div class="product-item">
                    <div class="image">
                        <img src="frontend/assets/images/trending-product/4.png" alt="">
                        <div class="tag sale">Sale</div>
                    </div>
                    <div class="text">
                ...
                <div class="product-item">
                    <div class="image">
                        <img src="frontend/assets/images/trending-product/5.png" alt="">
                        <div class="tag new">New</div>
                    ...
                    <div class="highlight-wrap">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="frontend/assets/images/top-selling/1.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="frontend/assets/images/top-selling/2.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="frontend/assets/images/top-selling/3.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="highlight-wrap">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="frontend/assets/images/recently-added/1.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="frontend/assets/images/recently-added/2.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="frontend/assets/images/recently-added/3.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="highlight-wrap">
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="frontend/assets/images/top-rated/1.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                                <h3><a href="product.html">Kids Shoes</a></h3>
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="frontend/assets/images/top-rated/2.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                                <h3><a href="product.html">Stylish Earrings</a></h3>
                        ...
                        <div class="product-card">
                            <div class="card-image">
                                <div class="image">
                                    <img src="frontend/assets/images/top-rated/3.png" alt="">
                                </div>
                            </div>
                            <div class="content">
                                <h3><a href="product.html">Yellow Hats</a></h3>
