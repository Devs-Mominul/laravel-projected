...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="frontend/assets/images/favicon.png">
    ...
    <link href="frontend/assets/css/flaticon_ecommerce.css" rel="stylesheet">
    ...
    <link href="frontend/assets/css/owl.theme.css" rel="stylesheet">
    <link href="frontend/assets/css/slick.css" rel="stylesheet">
    <link href="frontend/assets/css/slick-theme.css" rel="stylesheet">
    <link href="frontend/assets/css/swiper.min.css" rel="stylesheet">
    <link href="frontend/assets/css/owl.transitions.css" rel="stylesheet">
    <link href="frontend/assets/css/jquery.fancybox.css" rel="stylesheet">
    <link href="frontend/assets/css/odometer-theme-default.css" rel="stylesheet">
    <link href="frontend/assets/sass/style.css" rel="stylesheet">
</head>
...
<body>
        ...
        <div class="preloader">
            <div class="vertical-centered-box">
                <div class="content">
                    ...
                    <img src="frontend/assets/images/preloader.png" alt="">
                </div>
            </div>
        </div>
        <!-- end preloader -->
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-2">
                            <div class="navbar-header">
                                <a class="navbar-brand" href="index.html"><img src="frontend/assets/images/logo.svg"
                                        alt="logo"></a>
                            </div>
                        </div>
                                                ...
                                                <div class="mini-cart-items">
                                                    <div class="clearfix mini-cart-item">
                                                        <div class="mini-cart-item-image">
                                                            <a href="product.html"><img src="frontend/assets/images/cart/img-1.jpg" alt></a>
                                                        </div>
                                                    ...
                                                    <div class="clearfix mini-cart-item">
                                                        <div class="mini-cart-item-image">
                                                            <a href="product.html"><img
                                                                    src="frontend/assets/images/cart/img-2.jpg"
                                                                    alt></a>
                                                        </div>
                                                        <div class="mini-cart-item-des">
                                                    ...
                                                    <div class="clearfix mini-cart-item">
                                                        <div class="mini-cart-item-image">
                                                            <a href="product.html"><img
                                                                    src="frontend/assets/images/cart/img-3.jpg"
                                                                    alt></a>
                                                        </div>
                                                        <div class="mini-cart-item-des">
                    ...
                    <div class="row">
                        <div class="col col-lg-3 col-md-6 col-sm-12 col-12">
                            <div class="widget about-widget">
                                <div class="logo widget-title">
                                    <img src="frontend/assets/images/logo-2.svg" alt="blog">
                                </div>
                        ...
                        <div class="col col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="widget instagram">
                                ...
                                <ul class="d-flex">
                                    <li><a href="project-single.html"><img src="frontend/assets/images/instragram/1.jpg"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img src="frontend/assets/images/instragram/2.jpg"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img src="frontend/assets/images/instragram/4.jpg"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img src="frontend/assets/images/instragram/3.jpg"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img src="frontend/assets/images/instragram/4.jpg"
                                                alt=""></a></li>
                                    <li><a href="project-single.html"><img src="frontend/assets/images/instragram/1.jpg"
            ...
            <div class="wpo-newsletter-popup-area">
                <div class="wpo-newsletter-popup-ineer">
                    ...
                    <div class="img-holder">
                        <img src="frontend/assets/images/newsletter.jpg" alt>
                    </div>
                    <div class="details">
    ...
    <script src="frontend/assets/js/jquery.dlmenu.js"></script>
    <script src="frontend/assets/js/jquery-plugin-collection.js"></script>
