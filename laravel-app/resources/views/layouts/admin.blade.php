                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
								...
								<div class="rounded dropdown-menu dropdown-menu-right">
									<div id="DZ_W_TimeLine11Home" class="p-3 widget-timeline dz-scroll style-1 height370 ps ps--active-y">
										<ul class="timeline">
											<li>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										...
										<p class="mb-0 fs-12">{{ Auth::user()->email }}</p>
									</div>
                                </a>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="{{ route('catagory.upload') }}">Add Catagory</a></li>
							<li><a href="{{ route('trushed') }}">trush catagory</a></li>
							<li><a href="{{ route('subcatagory') }}">Subcatagory</a></li>
							<li><a href="{{ route('brandpreview') }}">Brand</a></li>
                            <li><a href="{{ route('product') }}">product</a>
                                <ul>
                                    <li><a href="{{ route('list.product') }}">Product List</a></li>
                                    <li><a href="{{ route('varition') }}">Variation List</a></li>
                                </ul>
                            </li>
						</ul>
                    </li>
				...
				<div class="add-menu-sidebar">
					...
					<p class="mb-0 font-w500">Create Workout Plan Now</p>
				</div>
				<div class="copyright">
